...
public class LogAgent
{
    ...
    {
        if(INSTANCE == null) new LogAgent(Constants.LAUNCHER_NAME, "Launcher", new File(Constants.LAUNCHER_NAME + "/launcher.log"), new File(Constants.LAUNCHER_NAME + "/launcher_1.log"));
